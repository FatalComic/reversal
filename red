...
local audioUrl = "https://cdn.discordapp.com/attachments/1268243270966837422/1294660070310674432/reversal_red.mp3?ex=670bd1a6&is=670a8026&hm=f6d3973561a5eca1c073f25c2ac9cb83844fc889e8259357789cef7f1ca66f2f&" -- Replace with your actual audio URL
...
local function createScreenRedFlash()
    ...
    -- Quick fade out the flash frame
    local fadeOutDuration = 0.1 -- Duration for the flash
    for i = 0, 1, 1 / (fadeOutDuration * 60) do
...
if effect and newEffect and sound then
    ...
    if rightHand then
        ...
        createScreenRedFlash() -- Call the function for the screen flash
